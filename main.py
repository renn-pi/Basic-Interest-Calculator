...
<FamilySavingScreen>:
    BoxLayout:
        canvas.before:
#            Color:
#                rgba: 227/255,237/255,246/255, 1
            Rectangle:
                source: 'bg1.jpg'
                pos: self.pos
                size: self.size
        ...
        MDBoxLayout:
            ...
            MDRaisedButton:
                ...
                size_hint: None, None
                #52,29,159
                #md_bg_color: 227/255,237/255,246/255, 1
                size: dp(200), dp(50) #2nd dp is the width of button
                pos_hint: {"center_x": .5}
...
#                rgba: 212/255,244/255,243/255, 1
        ...
        MDBoxLayout:
            ...
            MDLabel:
                ...
                theme_text_color: 'Secondary' #['Primary', 'Secondary', 'Hint', 'Error', 'Custom', 'ContrastParentBackground']
...
class SavingsApp(MDApp):
    def build(self):
        self.theme_cls.primary_palette = "Indigo" #'Red', 'Pink', 'Purple', 'DeepPurple', 'Indigo', 'Blue',
